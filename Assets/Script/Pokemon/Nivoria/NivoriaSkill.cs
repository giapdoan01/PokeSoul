...
public class NivoriaSkill : MonoBehaviour, IPokemonSkillLaunch
{
    ...
    private void ApplyTickDamageToTrackedEnemies()
    {
        ...
        for (int i = 0; i < enemiesInTrigger.Count; i++)
        {
            ...
            if (enemyHp == null || !enemyHp.gameObject.activeInHierarchy) continue;
    ...
    {
        if (targetEnemy != null) return targetEnemy.position;
        if (ownerSkill != null) return ownerSkill.CastPoint.position;
